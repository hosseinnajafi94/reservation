...
use Yii;
/**
 * This is the model class for table "view_list_reservations_completed".
 ...
 */
class ViewListReservationsCompleted extends \yii\db\ActiveRecord {
    public static function tableName() {
        return 'view_list_reservations_completed';
    }
